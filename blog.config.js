...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '11085c3dc58c804d8f77f46b85035cac',
  ...
  GREETING_WORDS:
    ...
    'Hi, 大家好, 我是一名普通的大学牲, 欢迎来到我的个人网站😶‍🌫️',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiaoyuezhou.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'df, 个人主页, 笔记分享', // 网站关键词 英文逗号隔开
  ...
  FACEBOOK_PAGE_TITLE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_TITLE || null, // 边栏Facebook Page widget的标题栏，填''则无标题栏e.g FACEBOOK粉丝团'
  ...
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || 'Dashboard', // 在Algolia中创建一个index用作数据库
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://comments-home.xiaoyuezhou.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '21132359', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'ocm69ag01x', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '7303845412', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
